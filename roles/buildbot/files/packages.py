        ...
        steps.ShellCommand(
            ...
            command=[
                ...
                util.Interpolate(
                    ...
                    #
                    """\
sudo podman run -i --rm --pids-limit=0 --log-driver=none --network=slirp4netns --tmpfs /root:rw,size=12582912k,mode=1777 docker.io/library/alpine:%(kw:alpineVersion)s sh -c '\
( \
